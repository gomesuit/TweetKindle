...
public class TitleConvert {
    ...
    private boolean isAdult(String title){
    	...
    	buffer.append("|躰");
    	buffer.append("|露出");
    	buffer.append("|comic甘苺");
    	buffer.append("|ハメちゃ");
    	buffer.append("|らめぇ");
    	buffer.append("|イカされ");
    	buffer.append("|媚薬");
    	buffer.append("|羞恥");
    	buffer.append("|カウパーニア");
    	buffer.append("|喘げ");
    	buffer.append("|悪戯");
    	buffer.append("|調教");
    	buffer.append("|ベッドイン");
    	...
    	buffer.append("|イキ声");
    	buffer.append("|命令は絶対");
    	buffer.append("|母親スワップ");
    	buffer.append("|いじめてあげる");
    	buffer.append("|ドＳ");
    	buffer.append("|レンタル彼氏");
    	buffer.append("|mobaman-F");
